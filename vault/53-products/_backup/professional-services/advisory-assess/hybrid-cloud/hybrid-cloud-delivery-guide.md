...
2. **Discovery workshop** (S: 1 hour, M: half day, L: 1-2 days, XL: 2-3 days)
...
2. **Cloud-first**: Move everything to public cloud. What does it cost?
3. **Hybrid optimized**: Place each workload in its best-fit environment. What does it cost?
4. **Repatriation** (if applicable): Bring cloud workloads back on-prem/private. What does it cost?
...
2. **Define migration/optimization path**: Which workloads move where, in what order
...
5. **Write the report and prepare presentation**
...
2. Current state overview with key findings
3. TCO comparison across scenarios (the money slide)
4. Recommended target architecture
5. Phased roadmap with timeline and milestones
6. Recommended next steps (follow-on services)
7. Q&A
