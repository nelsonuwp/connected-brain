# App & Platform Modernization Assessment -- Sell Sheet
...
**"You're running Kubernetes and Docker on 7-year-old hardware with no CI/CD pipeline. Your platform ambitions are 2026 but your foundation is 2018. Let's close that gap."**

---

## Who This Is For

- Companies with modern application ambitions running on legacy infrastructure
- Engineering teams using containers and cloud-native tools without a platform strategy
- Organizations with manual deployment processes, slow release cycles, or deployment reliability issues
- Businesses evaluating Kubernetes, CI/CD, or platform engineering investments

**Target personas**: VP Engineering, Director of DevOps, Head of Platform Engineering, CTO, Cloud Architect

---

## Pain Signals to Listen For

- "We're using Docker/Kubernetes but it's kind of held together with duct tape"
- "Deploying takes way too long"
- "We break things when we deploy"
- "Someone SSHs into the server to push code"
- "We want to containerize but don't know where to start"
- "We have multiple dev teams doing things differently"
- "Our CI/CD is manual or barely automated"
- "We need to ship faster but can't without breaking things"

---

## discovery conversation Mapping

This assessment answers: **"Where do you want to be?"** -- for technology-forward customers who have modern ambitions but lack the platform foundation.
...
| **XL** | $35K+ | 10+ applications, enterprise-scale platform design, full Well-Architected style engagement | 6-8 weeks |
...
| Platform architecture recommendation | -- | Yes | Detailed | Enterprise blueprint |
| Modernization roadmap | Memo | Phased plan | Detailed roadmap | Executive roadmap + POC scope |
| Technology stack recommendations | -- | Yes | Yes + alternatives | Full evaluation matrix |

---

## Campaign Tie-In

Not directly tied to a campaign. This assessment serves **tech-forward customers** in the target account set who show strong DevOps/container signals (Kubernetes, Docker, Terraform, ArgoCD intent).

It pairs well with **Campaign 2 (Time to Grow Up)** for companies that need to mature their engineering practices alongside their infrastructure.
