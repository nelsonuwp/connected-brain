# Infrastructure Risk & Readiness Assessment -- Sell Sheet
...
**"Your infrastructure is X years old. Do you know what's end-of-life, what's at risk of failure, and what it would cost you if it went down tomorrow?"**

---

## Who This Is For

- Companies running aging on-prem or colo infrastructure
- Small-to-mid-size IT teams managing 5-8+ year old servers
- Organizations with deferred maintenance and no hardware refresh plan
- Any customer with Aptum-hosted infrastructure that hasn't been audited recently

**Target personas**: IT Director, VP Infrastructure, SysAdmin, Infrastructure Manager

---

## Pain Signals to Listen For

Listen for any of these in conversation:

- "Our servers are getting old but still running... for now"
- "We had an outage last month and it took forever to fix"
- "I honestly don't know when our hardware was last refreshed"
- "We're still running Windows Server 2012" (or CentOS 5/7, RHEL 7, Debian 8)
- "Our firewalls are the same ones from when we moved in"
- "Patching? We'll get to it when we have time"
- "If that server goes down, we're in trouble"

---

## discovery conversation Mapping

This assessment answers the question: **"What are you dealing with right now?"**

It also connects to **"What's holding you back?"** -- when the customer is afraid to touch anything because they don't know what will break.
...
| **XL** | $30K+ | Enterprise-scale, multiple sites, full remediation roadmap with executive presentation | 4-6 weeks |
...
- **Enterprise, multiple sites, executive-level deliverable needed** = XL
...
| Capacity & performance baseline | -- | Yes | Yes | Yes |
| Prioritized remediation roadmap | Top 10 | Full | Full | Full + phased plan |
| Cost estimates for remediation | -- | Estimate | Detailed | Detailed + business case |
| Executive summary presentation | -- | -- | Yes | Yes + workshop |
