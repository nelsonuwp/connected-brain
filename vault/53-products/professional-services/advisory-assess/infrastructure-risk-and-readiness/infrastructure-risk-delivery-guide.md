...
2. **Data collection request** (send within 24 hours of kickoff):
...
3. **Infrastructure discovery** (if no asset inventory exists):
...
3. Develop cost estimates for each remediation item
4. Prepare executive summary (L/XL)
5. Internal review with Aptum specialists (L/XL: also with Aptum leadership)

**Report structure**:
1. Executive Summary
2. Scope and Methodology
3. Current State Overview (inventory, topology)
...
7. Cost Estimates
8. Appendices (detailed device inventory, raw data)
...
2. Walk through the remediation roadmap
3. Q&A
4. Discuss recommended next steps (this is where follow-on opportunities surface)
5. Deliver final report (PDF)
