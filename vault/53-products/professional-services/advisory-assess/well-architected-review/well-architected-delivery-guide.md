...
1. **Write W-AR Report** using Aptum template (AWS or Azure variant)
1. **Internal review**
...
1. Pillar-by-Pillar Findings:
   - For each pillar: current state, findings, recommendations
1. Finding Summary (severity matrix / heat map)
1. Cost Optimization Opportunities (specific savings)
1. Remediation Roadmap
1. Appendices (detailed findings, service inventory)
...
1. Pillar-by-pillar highlights (top findings per pillar)
1. Critical risks that need immediate attention
1. Cost optimization opportunities (the money slide)
1. Remediation roadmap
