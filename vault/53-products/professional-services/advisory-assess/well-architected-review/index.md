# Well-Architected Review (AWS/Azure) -- Sell Sheet
...
**"You built your cloud environment fast. Now let's make sure it's built right -- secure, reliable, cost-optimized, and ready for what's next."**

---

## Who This Is For

- Companies running production workloads in AWS or Azure
- Organizations that have never formally reviewed their cloud architecture against best practices
- Businesses experiencing cloud performance issues, security concerns, or cost overruns
- Customers preparing for compliance audits, security reviews, or scaling events

**Target personas**: Cloud Architect, VP Engineering, CTO, Director of Infrastructure, DevOps Lead

---

## Pain Signals to Listen For

- "We built this in AWS/Azure years ago and haven't really reviewed it since"
- "We're not sure if our cloud setup follows best practices"
- "We're worried about security gaps in our cloud"
- "Our cloud costs keep creeping up and we're not sure why"
- "We had a cloud outage and realized our architecture wasn't as resilient as we thought"
- "We need to prepare for a SOC 2 / HIPAA audit on our cloud environment"
- "We're scaling up and need to make sure our cloud can handle it"

---

## discovery conversation Mapping

This assessment answers: **"Where do you want to be?"** -- specifically for customers already in cloud who want to ensure their architecture is optimized, secure, and following best practices.
...
| **XL** | $40K+ | Full enterprise review, multi-account, multi-region, governance framework, executive transformation roadmap | 6-8+ weeks |
...
- **Multi-account, multi-region, governance, exec roadmap** = XL
...
| Cost optimization analysis | Basic | Detailed | Detailed + projections | Enterprise cost governance |
| Architecture diagrams | -- | Current state | Current + target state | Full architecture blueprint |
| Executive presentation | -- | -- | Yes | Yes + governance framework |

**Report follows the AWS/Azure Well-Architected Report template format** (per the existing Aptum W-AR report templates for AWS and Azure).

---

## Campaign Tie-In

Not directly tied to a specific campaign. However, this assessment serves customers who are **committed to cloud** but need to optimize their existing environment. It's complementary to the Hybrid Cloud and Cloud Repatriation assessments -- for customers where the answer is "stay in cloud, but do it better."
