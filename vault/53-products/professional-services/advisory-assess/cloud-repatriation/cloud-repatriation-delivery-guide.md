...
1. **Selective repatriation**: Move top repatriation candidates to private infrastructure. Keep the rest in cloud.
1. **Aggressive repatriation**: Move everything portable. Only keep cloud-native workloads.
1. **Hybrid optimized**: Right-place every workload (may be same as #2 with more nuance).
...
1. **Define migration approach** per workload
...
1. The savings opportunity: "Here's what you could save" (the money slide)
1. Workload-by-workload recommendation: stay, move, or optimize
1. TCO comparison across scenarios (visual: bar chart or table)
1. Recommended target architecture
1. Phased roadmap with timeline and milestones
1. Recommended next steps: repatriation execution project
