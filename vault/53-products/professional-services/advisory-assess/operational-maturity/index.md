# Operational Maturity Assessment -- Sell Sheet
...
- Small-to-mid-size companies (10-100 employees) with tiny IT teams managing aging infrastructure
- Organizations where IT staff spends 80%+ of time on reactive operations
- Businesses with no structured monitoring, incident management, or patching process
- Any customer drowning in operational overhead and considering "is there a better way?"

**Target personas**: IT Manager, Director of IT, Small Business Owner, VP Operations

---

## Pain Signals to Listen For

- "It's just me and one other person managing everything"
- "We spend all our time keeping things running, never improving anything"
- "When something breaks at 2 AM, I get the call"
- "We know we should be patching more often, but who has time?"
- "We don't really have monitoring -- we find out something's down when users call"
- "I can't hire fast enough to keep up"
...
This assessment answers: **"What's holding you back?"** -- the team is overwhelmed by operational overhead and can't innovate or grow.

This is often the **natural follow-on from an Infrastructure Risk Assessment** (Assessment #1). If the Infra Risk assessment reveals deferred maintenance, the Ops Maturity assessment asks "why?" and quantifies the operational cost.
...
| **XL** | $30K+ | Enterprise transformation: operational model redesign, runbook creation, managed services transition plan. Bespoke. | 4-6 weeks |
...
- **Enterprise, multi-site, operational transformation** = XL
...
| Staffing analysis (FTE cost on ops vs. core business) | Basic | Full | Full | Full + future state model |
| Operational process assessment | -- | Key processes | All domains | All domains + maturity scoring |
| Transition roadmap to managed services | Recommendation | Phased plan | Detailed roadmap | Full transition plan + runbooks |

---

## Campaign Tie-In

Not directly tied to a specific campaign. However, this is the **"land and expand" assessment** -- it's the easiest to sell to small customers and leads directly to managed services (the stickiest recurring revenue).

Among priority accounts, many are small-to-mid-size companies (10-100 employees) with tiny IT teams. This assessment makes the "let us manage it" conversation data-driven instead of salesy.
