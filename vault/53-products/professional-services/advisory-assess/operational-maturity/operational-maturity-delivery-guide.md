...
1. **Schedule individual interviews** with each IT team member (30-60 min each)
...
1. Executive Summary
1. Current Operational Model Overview
1. Operational Maturity Scoring (by domain)
1. Incident Analysis & Trends
1. Staffing & Cost Analysis
1. TCO Comparison: Self-Managed vs. Managed
1. Risk Assessment
1. Recommendations
...
1. "Here's what it costs" (TCO breakdown -- often an eye-opener)
1. "Here's what's at risk" (deferred maintenance, single-person dependencies, unmonitored systems)
1. "Here's the alternative" (managed services model with cost comparison)
1. "Here's how to get there" (transition roadmap)
1. Q&A
