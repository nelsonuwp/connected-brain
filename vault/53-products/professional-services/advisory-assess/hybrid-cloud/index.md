# Hybrid Cloud Assessment -- Sell Sheet
...
**"You're showing all the signs of a company evaluating cloud. Before you move anything, let's figure out which workloads belong where so you don't end up with the same problem in a different place."**

---

## Who This Is For

- Companies with a mix of on-prem, colo, and/or cloud infrastructure
- Organizations considering cloud migration or expansion
- Businesses facing rising cloud costs and questioning their strategy
- Anyone who ended up "hybrid by accident" and needs to be "hybrid by design"

**Target personas**: CTO, CIO, VP Infrastructure, Cloud Architect, Director of IT, Head of Cloud Strategy

---

## Pain Signals to Listen For

- "We're in the cloud but we're not sure everything belongs there"
- "Our cloud bill keeps going up but nothing feels faster"
- "We want to move to cloud but we don't know where to start"
- "We've got stuff everywhere -- some in AWS, some on-prem, some here with you"
- "Our VMware licensing just went up and we need alternatives"
- "We need to keep data in-country but still use cloud"
- "We modernized some things but the rest is still legacy"

---

## discovery conversation Mapping

This assessment answers: **"Where do you want to be?"**

It catches customers before they make a bad cloud move and positions Aptum as the strategic guide. It's also the primary CTA for **Campaign 2 (Time to Grow Up)** and **Campaign 3 (Cloud Hangover)**.
...
| **XL** | $40K+ | 50+ workloads, global footprint, multi-cloud, regulatory complexity, executive roadmap | 6-8 weeks |
...
| Architecture & compliance review | -- | Basic | Full | Full + regulatory |
| Target architecture & roadmap | Recommendation | Phased plan | Detailed roadmap | Executive roadmap + business case |

---

## Campaign Tie-In

This is the **primary assessment CTA for two of three active campaigns**:

- **Campaign 2: Time to Grow Up** -- Post-scale companies with board pressure on cloud costs. The Hybrid Cloud Assessment is the natural next step after a roadmap call.
- **Campaign 3: The Cloud Hangover** -- Cloud-fatigued mid-market. The physical mailer drives awareness; the assessment is the conversion point.

When following up on leads from these campaigns, reference the white paper they received and the pain signals it addresses.
