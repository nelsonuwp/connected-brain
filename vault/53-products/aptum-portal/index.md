...
Today the portal does provisioning well. VPC self-service, Azure subscription management, and Cloudflare DNS are live. The monetization engine is operational. The highest-priority product gap is that managed services are not yet visible in the portal: a customer paying for OS patching, managed backup, and managed detection and response cannot see any of that through the portal. Making managed services visible at Layers 1 and 2 is the engineering priority that converts the portal from a provisioning tool into a retention engine.

See Aptum Portal Strategy and Roadmap for the strategic rationale and three-phase roadmap. See Aptum Portal PRD for the full product requirements.
